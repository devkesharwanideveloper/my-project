    ...
    <>
      <div className="container mx-auto px-4 md:px-8 bg-gray-900 min-h-screen rounded-2xl shadow-2xl my-8 p-6 md:p-12 border border-gray-800">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-1">
          ...
          <div className="flext flex-col justify-between">
            ...
            <h2 className="text-xl font-bold text-gray-200 mb-2 border-b border-e-orange-900/50 pb-2 flext items-center space-x-2 ">
              {" "}
              <Tag className="w-5 h-5 text-orange-500 " />{" "}
              <span>Prouduct Overview</span>
            </h2>
